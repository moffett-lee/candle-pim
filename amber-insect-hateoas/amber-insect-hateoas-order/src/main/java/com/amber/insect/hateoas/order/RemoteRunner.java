...
import com.amber.insect.hateoas.order.entity.StocksEntity;
import com.amber.insect.hateoas.order.repository.OrderRepository;
...
public class RemoteRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Resource americano = updateStocks(updateLink);
        // Step 3: 重新查询打印股票信息
        queryStocks(stocksLink);
